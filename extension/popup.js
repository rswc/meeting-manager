...
browser.runtime.onMessage.addListener((msg) => {
    if (msg.action === 'RECV' && Array.isArray(msg.data)) {
        ...
        for (const evt of msg.data) {
            ...
            el.innerHTML = `<div class="evt_title">${evt.Title}</div><div class="evt_time" data-date="${evt.Date}" data-timestamp="${evt.Timestamp}">00</div><div class="evt_misc">${evt.Recurring}</div>`;
